...
describe('McMiniCalendrierComponent', () => {
  ...
  describe('grille — grisage des jours', () => {
    it('samedi et dimanche sont grisés et désactivés', () => {
      ...
      const samedi = fixture.nativeElement.querySelector(
        '#calendrierJour_2026-06-06',
      ) as HTMLButtonElement;
      const dimanche = fixture.nativeElement.querySelector(
        '#calendrierJour_2026-06-07',
      ) as HTMLButtonElement;
    ...
    it('jour férié est grisé et désactivé', () => {
      ...
      fixture.detectChanges();
      const mercrediFerie = fixture.nativeElement.querySelector(
        '#calendrierJour_2026-06-03',
      ) as HTMLButtonElement;
    ...
    it('jour de semaine absent de joursOuvres est grisé', () => {
      ...
      fixture.detectChanges();
      const lundi = fixture.nativeElement.querySelector(
        '#calendrierJour_2026-06-01',
      ) as HTMLButtonElement;
    ...
    it('jour de semaine dans joursOuvres est actif', () => {
      ...
      const mardi = fixture.nativeElement.querySelector(
        '#calendrierJour_2026-06-02',
      ) as HTMLButtonElement;
  ...
  describe('grille — marqueurs visuels', () => {
    it('date dans journeesAvecEntrees a la classe --entree', () => {
      ...
      fixture.detectChanges();
      const avecEntree = fixture.nativeElement.querySelector(
        '#calendrierJour_2026-06-10',
      ) as HTMLButtonElement;
      const sansEntree = fixture.nativeElement.querySelector(
        '#calendrierJour_2026-06-11',
      ) as HTMLButtonElement;
    ...
    it('jourSelectionne a la classe --selectionne et aria-pressed=true', () => {
      ...
      fixture.detectChanges();
      const selectionne = fixture.nativeElement.querySelector(
        '#calendrierJour_2026-06-10',
      ) as HTMLButtonElement;
      const autre = fixture.nativeElement.querySelector(
        '#calendrierJour_2026-06-11',
      ) as HTMLButtonElement;
    ...
    it('date du jour a la classe --aujourdhui', () => {
      ...
      fixture.detectChanges();
      const btnAujourdhui = fixture.nativeElement.querySelector(
        `#calendrierJour_${iso}`,
      ) as HTMLButtonElement;
    ...
    it('affiche les initiales du lundi au dimanche (L M M J V S D)', () => {
      ...
      const entetes = Array.from(
        fixture.nativeElement.querySelectorAll(
          '.mc-mini-calendrier__entete-col',
  ...
  describe('libellé du mois', () => {
    it("affiche le mois et l'année en français", () => {
      const libelle = (
        fixture.nativeElement.querySelector('.mc-mini-calendrier__libelle-mois') as HTMLElement
      ).textContent?.trim();

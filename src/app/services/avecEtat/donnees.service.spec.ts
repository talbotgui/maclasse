...
function creerDonnees(version = '1.0'): DonneesApplication {
  return {
    version,
    configuration: { delaiSauvegardeAutoMinutes: 2 },
    enseignant: { prenom: 'Jean', nom: 'Dupont', annee: '2025-2026' },
    classe: { niveau: 'CM1', annee: 'Classe CM1', eleves: [] },
    referentiels: {
      competences: [],
      periodes: [],
      statutsAcquisition: [],
...
describe('DonneesService', () => {
  ...
  describe('charger', () => {
    ...
    it('isole les données par clonage — mutation externe sans effet', () => {
      const original = creerDonnees('v1');

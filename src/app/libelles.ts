...
export const LIBELLES = {
  ...
  demarrage: {
    ...
    ariaAfficherMotDePasse: 'Afficher le mot de passe',
    ariaMasquerMotDePasse: 'Masquer le mot de passe',
  ...
  competences: {
    ...
    erreurExport:
      "L'export a échoué : la période ou la séance ciblée n'existe plus. Le panier a été conservé.",
    ariaAjouterAuPanier: 'Ajouter au panier : ',
    ariaPanier: 'Panier de compétences',
    ariaRetirer: 'Retirer ',
    ariaReplierNoeud: 'Replier ',
    ariaDeplierNoeud: 'Déplier ',
    ariaArbreCompetences: 'Arbre des compétences',
  },
  ...
  edt: {
    ...
    titreListeEdtCalcules: 'Mes emplois du temps calculés',
    boutonCreerEdtCalcule: 'Créer un emploi du temps calculé',
    aucunEdtCalcule: 'Aucun emploi du temps calculé.',
    ariaListeEdtCalcules: 'Liste des emplois du temps calculés',
    titreEdtCalcule: 'Emploi du temps calculé',
    labelSources: 'Sources',
    sourceRecreation: 'Récréations',
  ...
  cahierJournal: {
    ...
    avertissementSuppressionJournee:
      'Toutes les séances et notes de cette journée seront supprimées définitivement. Voulez-vous continuer ?',
    labelHeureDebut: 'Heure de début',
    labelHeureFin: 'Heure de fin',
    labelType: 'Type',
  ...
  commandes: {
    ...
    ajoutEdtCalcule: "Ajout d'un emploi du temps calculé",
    modificationEdtCalcule: "Modification d'un emploi du temps calculé",
    suppressionEdtCalcule: "Suppression d'un emploi du temps calculé",
  ...
  aria: {
    ...
    calendrierAujourdhui: ' — Aujourd’hui',
    calendrierAvecEntree: ' — Séances renseignées',
  },
} as const;
